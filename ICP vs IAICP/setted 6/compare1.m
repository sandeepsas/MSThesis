...
%%%%%%%%%%%%%%
% Loading files
load water1_trimmed.txt
load water2_trimmed.txt
% Zscore intensity normalization
Intensity_Data=water1_trimmed(:,4);
Intensity_Model=water2_trimmed(:,4);
 ZnormInt_Data= ZscoreNormalizeIntensity(water1_trimmed);
 ZnormInt_Model= ZscoreNormalizeIntensity(water2_trimmed);
